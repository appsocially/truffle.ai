...
riot.tag2('module-problem', '<div class="wrap-module py40"> <h2 class="lead mb24">Truffleの特徴</h2> <div class="wrap-problem-item f flex-between mb30" each="{item in contents}"> <div class="wrap-img f fh mr40"><img riot-src="{item.src}"></div> <div class="wrap-explain f fm"> <div> <h3 class="mb12">{item.title}</h3> <p>{item.explain}</p> </div> </div> </div> <div class="mt40 f fc"> <item-cta-button content="{cta}"></item-cta-button> </div> </div>', 'module-problem,[data-is="module-problem"]{display:block;width:100%;background:#ffffff} module-problem .wrap-module,[data-is="module-problem"] .wrap-module{width:90%;max-width:880px;margin:0 auto} module-problem .wrap-module h2,[data-is="module-problem"] .wrap-module h2{text-align:center;font-size:32px} module-problem .wrap-module .wrap-problem-item .wrap-img,[data-is="module-problem"] .wrap-module .wrap-problem-item .wrap-img{overflow:hidden} module-problem .wrap-module .wrap-problem-item .wrap-img img,[data-is="module-problem"] .wrap-module .wrap-problem-item .wrap-img img{width:240px;border-radius:50%} module-problem .wrap-module .wrap-problem-item .wrap-explain h3,[data-is="module-problem"] .wrap-module .wrap-problem-item .wrap-explain h3{font-size:22px}@media only screen and (max-width : 600px){ module-problem .wrap-problem-item,[data-is="module-problem"] .wrap-problem-item{display:block} module-problem .wrap-problem-item .wrap-img,[data-is="module-problem"] .wrap-problem-item .wrap-img{width:100%;margin-right:0 !important;margin-bottom:24px} module-problem .wrap-problem-item .wrap-img img,[data-is="module-problem"] .wrap-problem-item .wrap-img img{width:160px !important}}', '', function(opts) {
    this.contents = [
      {
        index: "Feature 1",
      ...
      },
      {
        index: "Feature 2",
        title: "面接の実施率アップ",
        explain: "AIがリマインドなどにより、応募者を面接当日までサポートするため、より確実に面接を実施することが可能です。",
