...
riot.tag2('item-cta-button', '<a class="px18 py12" href="{href}" target="brank">{label}</a>', 'item-cta-button,[data-is="item-cta-button"]{display:block} item-cta-button a,[data-is="item-cta-button"] a{cursor:pointer;border-radius:3px;letter-spacing:1px;color:#ffffff;background:#FF6666}', 'class="f fc"', function(opts) {
...
riot.tag2('module-about', '<div class="wrap-module py50"> <div class="module-content"> <p>Truffle AIは応募から面接までの採用業務を全て自動で完了するチャットボットです。採用担当者の仕事を大幅に削減しながら、より確実な人材採用をサポートします。</p> </div> </div>', 'module-about,[data-is="module-about"]{display:block;width:100%;background:#eeeeee} module-about .wrap-module,[data-is="module-about"] .wrap-module{width:90%;max-width:980px;margin:0 auto} module-about .wrap-module h2,[data-is="module-about"] .wrap-module h2{text-align:center;font-size:32px} module-about .wrap-module .module-content,[data-is="module-about"] .wrap-module .module-content{width:90%;max-width:980px;margin:0 auto} module-about .wrap-module .module-content p,[data-is="module-about"] .wrap-module .module-content p{font-size:16px} module-about .wrap-module .module-content .wrap-concept-movie,[data-is="module-about"] .wrap-module .module-content .wrap-concept-movie{position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden} module-about .wrap-module .module-content .wrap-concept-movie iframe,[data-is="module-about"] .wrap-module .module-content .wrap-concept-movie iframe{border:none;position:absolute;top:0;left:0;width:100%;height:100%} module-about .wrap-module .module-content .caption,[data-is="module-about"] .wrap-module .module-content .caption{display:block;text-align:center}', '', function(opts) {
});
...
riot.tag2('module-hiro', '<div class="wrap-module f flex-around"> <div class="wrap-explain f fm"> <div class="explain"> <div class="texts mb50"> <p each="{item in texts}">{item}</p> </div> <div class="wrap-img f fh s-show"><img src="./img/contents/iphone-truffle-tech.png"></div> </div> </div> <div class="wrap-img f fm s-hide"><img src="./img/contents/iphone-truffle-tech.png"></div> </div> <div class="bg"></div>', 'module-hiro,[data-is="module-hiro"]{position:relative;display:block;width:100%;height:80vh} module-hiro .wrap-module,[data-is="module-hiro"] .wrap-module{position:relative;width:100%;height:100%;left:0;top:0;z-index:10;margin:0 auto;width:90%} module-hiro .wrap-module .wrap-explain,[data-is="module-hiro"] .wrap-module .wrap-explain{height:100%;padding-top:48px} module-hiro .wrap-module .wrap-explain .explain .texts p,[data-is="module-hiro"] .wrap-module .wrap-explain .explain .texts p{font-size:42px} module-hiro .wrap-module .wrap-img,[data-is="module-hiro"] .wrap-module .wrap-img{padding-top:48px;width:300px;height:100%} module-hiro .bg,[data-is="module-hiro"] .bg{position:absolute;display:block;width:100%;height:100%;left:0;top:0;background-image:url(img/contents/hiro2.jpg);background-position:center center;background-repeat:no-repeat;background-attachment:fixed;background-size:cover;background-color:#ffffff}@media only screen and (max-width : 600px){ module-hiro,[data-is="module-hiro"]{height:100vh} module-hiro .wrap-module,[data-is="module-hiro"] .wrap-module{display:block} module-hiro .wrap-module .wrap-explain,[data-is="module-hiro"] .wrap-module .wrap-explain{height:100%;padding-top:48px;justify-content:center} module-hiro .wrap-module .wrap-explain .explain .texts,[data-is="module-hiro"] .wrap-module .wrap-explain .explain .texts{margin-bottom:30px !important} module-hiro .wrap-module .wrap-explain .explain .texts p,[data-is="module-hiro"] .wrap-module .wrap-explain .explain .texts p{font-size:28px;text-align:center} module-hiro .wrap-module .wrap-explain .explain .wrap-cta,[data-is="module-hiro"] .wrap-module .wrap-explain .explain .wrap-cta{display:block} module-hiro .wrap-module .wrap-explain .explain .wrap-img,[data-is="module-hiro"] .wrap-module .wrap-explain .explain .wrap-img{width:100%} module-hiro .wrap-module .wrap-explain .explain .wrap-img img,[data-is="module-hiro"] .wrap-module .wrap-explain .explain .wrap-img img{width:50%}}', '', function(opts) {
    this.texts = [
      "面接までを一瞬で",
      "採用をより確実に"
    ]
...
riot.tag2('module-keep-in-touch', '<div class="wrap-module py40"> <h2 class="mb40">お問い合わせ</h2> <div class="wrap-form pb30"> <div> <div class="wrap-textarea" id="wrapContactTextarea"> <textarea class="pt8 pl8 mb10" placeholder="お名前を入力"></textarea> <textarea class="pt8 pl8 mb10" placeholder="会社名を入力"></textarea> <textarea class="pt8 pl8 mb10" placeholder="メールアドレスを入力" id="addressInput"></textarea> <textarea class="pt8 pl8 mb10" placeholder="本文を入力" id="sentenceInput"></textarea> </div> </div> <div class="f fc"><span class="send-button f fh" onclick="{sendMail}">送信</span></div> </div> </div>', 'module-keep-in-touch,[data-is="module-keep-in-touch"]{display:block;width:100%;background:#eeeeee;position:relative;z-index:1000} module-keep-in-touch .wrap-module,[data-is="module-keep-in-touch"] .wrap-module{width:90%;max-width:980px;margin:0 auto} module-keep-in-touch .wrap-module h2,[data-is="module-keep-in-touch"] .wrap-module h2{text-align:center;font-size:32px} module-keep-in-touch .wrap-module p,[data-is="module-keep-in-touch"] .wrap-module p{text-align:center} module-keep-in-touch .wrap-module .wrap-form,[data-is="module-keep-in-touch"] .wrap-module .wrap-form{max-width:540px;margin:0 auto} module-keep-in-touch .wrap-module .wrap-form .wrap-textarea,[data-is="module-keep-in-touch"] .wrap-module .wrap-form .wrap-textarea{position:relative;z-index:100;margin:0 auto} module-keep-in-touch .wrap-module .wrap-form .wrap-textarea textarea,[data-is="module-keep-in-touch"] .wrap-module .wrap-form .wrap-textarea textarea{resize:none;width:100%;height:38px;filter:drop-shadow(1px 1px 1px rgba(100,100,100,0.6));border-radius:3px;background:#ffffff} module-keep-in-touch .wrap-module .wrap-form .wrap-textarea #sentenceInput,[data-is="module-keep-in-touch"] .wrap-module .wrap-form .wrap-textarea #sentenceInput{height:200px} module-keep-in-touch .wrap-module .wrap-form .send-button,[data-is="module-keep-in-touch"] .wrap-module .wrap-form .send-button{width:68px;height:38px;filter:drop-shadow(1px 1px 1px rgba(100,100,100,0.6));border-radius:3px;background:#ffcc33}', '', function(opts) {
...
riot.tag2('module-user-flow', '<div class="wrap-module pb40"> <div class="wrap-module-content f flex-between"> <div class="wrap-user-flow-item pb20" each="{item in content}"> <h3 class="mb12">{item.title}</h3> <div class="f fc"><img riot-src="{item.src}"></div> </div> </div> <div class="wrap-demo-prototype f fc py20"> <div class="demo-prototype"><img src="./img/contents/user-flow/demo2.gif"></div> </div> </div>', 'module-user-flow,[data-is="module-user-flow"]{display:block;width:100%;background:#eeeeee} module-user-flow .wrap-module,[data-is="module-user-flow"] .wrap-module{width:90%;max-width:980px;margin:0 auto} module-user-flow .wrap-module h2,[data-is="module-user-flow"] .wrap-module h2{text-align:center;font-size:32px} module-user-flow .wrap-module .wrap-user-flow-item,[data-is="module-user-flow"] .wrap-module .wrap-user-flow-item{width:32%} module-user-flow .wrap-module .wrap-user-flow-item h3,[data-is="module-user-flow"] .wrap-module .wrap-user-flow-item h3{text-align:center} module-user-flow .wrap-module .wrap-user-flow-item img,[data-is="module-user-flow"] .wrap-module .wrap-user-flow-item img{max-height:320px} module-user-flow .wrap-module .wrap-demo-iframe p,[data-is="module-user-flow"] .wrap-module .wrap-demo-iframe p{text-align:center} module-user-flow .wrap-module .wrap-demo-iframe iframe,[data-is="module-user-flow"] .wrap-module .wrap-demo-iframe iframe{border:none;width:100%;max-width:375px;height:580px} module-user-flow .wrap-module .wrap-demo-prototype .demo-prototype,[data-is="module-user-flow"] .wrap-module .wrap-demo-prototype .demo-prototype{width:90%}@media only screen and (max-width : 600px){ module-user-flow .wrap-module-content,[data-is="module-user-flow"] .wrap-module-content{display:block} module-user-flow .wrap-module-content .wrap-user-flow-item,[data-is="module-user-flow"] .wrap-module-content .wrap-user-flow-item{width:90%;margin:0 auto}}', '', function(opts) {
    this.content = [
      {
      ...
      {
        title: '2. 応募受付＆日程調整',
        src: './img/contents/user-flow/iphone-truffle-tech.png',
      },
      {
...
riot.tag2('module-what', '<div class="wrap-module py40"> <h2 class="mb24">Truffle AIの機能</h2> <div class="wrap-card f flex-between flex-wrap"> <item-what-card each="{item in content}" content="{item}"></item-what-card> </div> </div>', 'module-what,[data-is="module-what"]{display:block;width:100%;background:#eeeeee} module-what .wrap-module,[data-is="module-what"] .wrap-module{width:90%;max-width:880px;margin:0 auto} module-what .wrap-module h2,[data-is="module-what"] .wrap-module h2{text-align:center;font-size:32px} module-what .wrap-module item-what-card,[data-is="module-what"] .wrap-module item-what-card{margin-bottom:20px !important}', '', function(opts) {
    this.content = [
      ...
      },
      {
        ...
        title: '事前に知りたい情報を収集',
        text: '応募から面接までの採用業務を全て自動で代行するチャットボットです。',
      },
      {
