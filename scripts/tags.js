...
riot.tag2('module-problem', '<div class="wrap-module py40"> <h2 class="lead mb24">Truffle AIの特徴</h2> <div class="wrap-problem-item f flex-between mb40" each="{item in contents}"> <img class="mr40" riot-src="{item.src}"> <div class="wrap-explain f fm"> <div> <h3 class="mb12">{item.title}</h3> <p>{item.explain}</p> </div> </div> </div> <div class="mt40 f fc"> <item-cta-button content="{cta}"></item-cta-button> </div> </div>', 'module-problem,[data-is="module-problem"]{display:block;width:100%;background:#ffffff} module-problem .wrap-module,[data-is="module-problem"] .wrap-module{width:90%;max-width:880px;margin:0 auto} module-problem .wrap-module h2,[data-is="module-problem"] .wrap-module h2{text-align:center;font-size:32px} module-problem .wrap-module .wrap-problem-item,[data-is="module-problem"] .wrap-module .wrap-problem-item{width:100%} module-problem .wrap-module .wrap-problem-item img,[data-is="module-problem"] .wrap-module .wrap-problem-item img{width:20%;border-radius:50%} module-problem .wrap-module .wrap-problem-item .wrap-explain,[data-is="module-problem"] .wrap-module .wrap-problem-item .wrap-explain{width:80%} module-problem .wrap-module .wrap-problem-item .wrap-explain h3,[data-is="module-problem"] .wrap-module .wrap-problem-item .wrap-explain h3{font-size:22px}@media only screen and (max-width : 600px){ module-problem .wrap-problem-item,[data-is="module-problem"] .wrap-problem-item{display:block;margin-bottom:48px} module-problem .wrap-problem-item img,[data-is="module-problem"] .wrap-problem-item img{width:200px !important;left:50%;margin-right:0 !important;margin-left:-100px;position:relative;margin-bottom:24px} module-problem .wrap-problem-item .wrap-explain,[data-is="module-problem"] .wrap-problem-item .wrap-explain{width:100% !important} module-problem .wrap-problem-item .wrap-explain h3,[data-is="module-problem"] .wrap-problem-item .wrap-explain h3{text-align:center}}', '', function(opts) {
    this.contents = [
