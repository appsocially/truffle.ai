...
riot.tag2('module-what', '<div class="wrap-module py40"> <h2 class="mb24">Truffleの機能</h2> <div class="wrap-card f flex-between flex-wrap"> <item-what-card each="{item in content}" content="{item}"></item-what-card> </div> </div>', 'module-what,[data-is="module-what"]{display:block;width:100%;background:#eeeeee} module-what .wrap-module,[data-is="module-what"] .wrap-module{width:90%;max-width:880px;margin:0 auto} module-what .wrap-module h2,[data-is="module-what"] .wrap-module h2{text-align:center;font-size:32px}', '', function(opts) {
    this.content = [
      {
